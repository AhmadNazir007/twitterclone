    ...
    <div className=''>
      ...
      <div className='border border-dark7'>
        ...
        <div className='flex items-center'>
           <Image src={AppIcons.avatar_medium} alt="Avatar"  width={49} height={49} />
        ...
        <div className='flex mt-4'>
          ...
          <div className='flex gap-2 ml-14'> 
           ...
           <Image src={AppIcons.schedule} alt="Avatar"  width={24} height={24} />
          </div>

          <div className='ml-64'>
           <Link href='/home' className='py-2 px-4 text-center font-sfcompactM text-h4 bg-primary_blue rounded-full text-white'> Tweet </Link>
          </div>
